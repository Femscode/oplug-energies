    ...
    <div class="solar-product-details-deal">
        <div class="solar-product-details-product">
            ...
            <div class="solar-product-details-swiper-wrapper">
                ...
                <div class="solar-product-details-thumb thumbnail-image"
                    ...
                    style="background-image: url(&quot;https://www.oplugenergies.com/oplug_files/public/uploads/products/{{ $image }}&quot;); background-size: cover; background-position: center; cursor: pointer; border: 2px solid {{ $index === 0 ? '#007bff' : 'transparent' }}; transition: all 0.2s ease;"
                    onclick="switchMainImage('https://www.oplugenergies.com/oplug_files/public/uploads/products/{{ $image }}', this)"></div>
                @endforeach
            </div>
            @endif
            <div class="solar-product-details-main-img">
                <div class="main-product-image" id="mainProductImage"
                    style="width: 100%; height: 100%; background-image: url('https://www.oplugenergies.com/oplug_files/public/uploads/products/{{ $images[0] }}'); background-size: cover; background-position: center; transition: all 0.3s ease;">
            ...
            <div class="solar-product-details-info">
                ...
                <div class="solar-product-details-details">
                    ...
                    <div class="solar-product-details-benefits">
                        <div class="solar-product-details-benefit">
                            <div class="solar-product-details-benefit-text">FREE SHIPPING</div>
                        </div>
                        <div class="solar-product-details-benefit-alt">
                            <div class="solar-product-details-benefit-text-alt">50% INSTALLATION</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="solar-product-details-checkout">
            ...
            <div class="solar-product-details-actions">
                ...
                <div class="solar-product-details-checkout-button">
                    <div class="solar-product-details-checkout-text">PROCEED TO CHECKOUT</div>
                </div>
                <div class="solar-product-details-cart-button add-to-cart-btn" data-product-id="{{ $product->id }}" style="cursor: pointer;">
                    <div class="solar-product-details-cart-text">ADD TO CART</div>
                </div>
            </div>
